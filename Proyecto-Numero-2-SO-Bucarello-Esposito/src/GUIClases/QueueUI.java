...
public class QueueUI extends javax.swing.JPanel {
    ...
    public void updateQueueUI(Queue queue) {
        ...
        while (!auxQueue.isEmpty()) {
            Personaje personaje = auxQueue.dequeue();
            this.addCard(personaje.getUrlSource());
        }
    ...
    private void initComponents() {
        ...
        backgroundQueue.setForeground(new java.awt.Color(255, 255, 255));
        backgroundQueue.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        titleQueueUI.setFont(new java.awt.Font("Heiti SC", 1, 12)); // NOI18N
        titleQueueUI.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titleQueueUI.setText("COLA PRIORIDAD:");
        backgroundQueue.add(titleQueueUI, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 20));
