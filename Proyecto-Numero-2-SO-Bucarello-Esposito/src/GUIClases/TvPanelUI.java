...
public class TvPanelUI extends javax.swing.JPanel {
    ...
    public void actualizarColasUI(Queue colaP1, Queue colaP2, Queue colaP3, Queue colaRefuerzo) {
        this.queueUI1.updateQueueUI(colaP1);
        this.queueUI2.updateQueueUI(colaP2);
        this.queueUI3.updateQueueUI(colaP3);
        this.queueUI4.updateQueueUI(colaRefuerzo);
    }
    ...
    private void initComponents() {
        ...
        queueUI1 = new GUIClases.QueueUI();
        queueUI2 = new GUIClases.QueueUI();
        queueUI3 = new GUIClases.QueueUI();
        logo = new javax.swing.JLabel();
        queueUI4 = new GUIClases.QueueUI();
        ...
        jPanel1.setBackground(new java.awt.Color(255, 232, 31));
        jPanel1.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        queueUI1.setBackground(new java.awt.Color(0, 0, 0));
        queueUI1.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private GUIClases.QueueUI queueUI1;
    private GUIClases.QueueUI queueUI2;
    private GUIClases.QueueUI queueUI3;
    private GUIClases.QueueUI queueUI4;
